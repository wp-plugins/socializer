...
Description: Socializer! is a free and light plugin that will let your posts and pages be shared at the top social networks, including Facebook (both share and like are supported), by eMail and through Google Plus. Check the <a href="http://www.socializer.info/" target="_blank">Home Page of Socializer!</a> for more information and technical support. If you like this plugin <a href="http://www.socializer.info/share.asp?docurl=http://www.socializer.info&doctitle=Socializer! The Best Way to Share the Web - Nice, Easy, Flexible, Free" target="_blank">share it with your friends</a>, and <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=8LEU4AZ8DWET2" target="_blank">buy me a coffee!</a>
...
<hr style="width:700px;color:#dfdfdf;margin-bottom:25px;" size="1" align="left">
	...
	<legend style="font-size:14pt;letter-spacing:2px;"> &nbsp; Options</legend>
	...
	<div style="padding: 20px 0 0 30px">
		<label><input type="checkbox" name="tfw_sindarch" value="checkbox" <?php if (get_option('tfw_sindarch')) echo "checked='checked'"; ?>/> &nbsp; Display on Archives (Home/Index, Categories, Tags, Dates)</label>
	</div>



<div style="padding: 45px 0 0 30px">
<b>Main position</b> (valid in single Post/Page <b>and</b> in Archive/Index views):
</div>
	...
	<div style="padding: 20px 0 0 30px">
		<label><input type="checkbox" name="tfw_spaf" value="checkbox" <?php if (get_option('tfw_spaf')) echo "checked='checked'"; ?>/> &nbsp; Display at the bottom of content (this might not work on Archives, if you use content trimming plugins)</label>
	</div>
...
<span style="letter-spacing:3px;">Div style of the Content Button</span> &mdash; Default is <b>text-align:left;</b> (the button is aligned to the left)
<br>
<br>
<input type="text" style="margin-left:22px;font-size:11pt;width:80%;" name="tfw_stldiv" value="<?php echo htmlspecialchars(stripslashes(get_option('tfw_stldiv'))) ?>">
...
<br>
<br>
<span style="letter-spacing:3px;">Div style of the Widget Button</span> &mdash; Default is <b>text-align:left;</b> (the button is aligned to the left)
<br>
<br>
<input type="text" style="margin-left:22px;font-size:11pt;width:80%;" name="tfw_stlwdiv" value="<?php echo htmlspecialchars(stripslashes(get_option('tfw_stlwdiv'))) ?>">
<br>
<br>
<br>
...
<span style="padding:3pt;letter-spacing:3px;">Change Content Button</span> &mdash; Default is<b> <?=WP_CONTENT_URL.'/plugins/'.plugin_basename(dirname(__FILE__)).'/'?>scl.gif </b>
<br>
...
<span style="padding:3pt;letter-spacing:3px;">Change Widget Button</span> &mdash; Default is<b> <?=WP_CONTENT_URL.'/plugins/'.plugin_basename(dirname(__FILE__)).'/'?>scl-sm.gif </b>
<br>
...
<div style="padding:1px 0 0 0;letter-spacing:2px;"> &nbsp; &raquo; <a style="color:#2b95ff;text-decoration:none;" href="http://www.thefreewindows.com/all-of-thefreewindows-own-utilities/" target="_blank">Check for more free stuff</a> 
 &nbsp; &raquo; 
...
<p style="font-size:14pt;letter-spacing:2px;">&nbsp; &nbsp; &nbsp; &nbsp; Enjoy!</p>
<br>
<br>
