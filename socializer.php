...
<hr style="width:700px;color:silver;margin-bottom:10px;" size="1" align="left">
...
Here is the address of the animated smaller content button (proper for light background):
<br>&nbsp;<br>
...
<div style="margin-left:70px;">
Here is the address of the animated and smaller widget button (proper for light background):
<br>&nbsp;<br>
...
<br>&nbsp;<br>
	...
	<div class="submit" style="background:#ececec;padding:7pt;margin:32px 42px 32px 22px;-moz-border-radius: 17px;border-radius: 17px;">
		<input style="font-weight:bold;letter-spacing:5px;color:#2b95ff;font-variant:all-caps" type="submit" name="info_update" value="<?php _e(' Update the Settings '); ?>" />
	</div>
	</form>
...
<p style="font-size:24pt;letter-spacing:3px;margin-left:180px;color:green;">Enjoy!</p>
<hr style="width:700px;color:silver;margin-bottom:25px;" size="1" align="left">
<br>

<div align="center" style="text-align:center;"> &nbsp;  &nbsp;  &nbsp; <a style="color:silver;text-decoration:none;font-weight:bold;font-size:20pt;letter-spacing:3px;" href="http://www.socializer.info/" target="_blank">www.socializer.info</a></div>
	</div>	
