...
<div id="SocializerW">		
	<div id="fb-root"></div><script type="text/javascript">
			...
			<td align="left" valign="bottom" style="border:none;vertical-align:bottom;background-color:transparent;background-image:none;"><?=$followbuttonw ?><a title="Share in top social networks, email, translate, and more!" style="border:none;" href='http://www.socializer.info/share.asp?docurl=http://<?php echo urlencode($_SERVER["HTTP_HOST"]) ?><?php echo urlencode($_SERVER["REQUEST_URI"]); ?>&doctitle=<?php wp_title(" - ",TRUE,"right"); ?>' target="_blank"><img src="<?=$socpath?><?=$imid?>.gif" title="Share in top social networks, email, translate, and more!" style="border:none;"></a></td></tr></table></div>        
<?php
    }
}
