...
class SocializerWidget extends WP_Widget {
	...
	$tfw_wsize = get_option('tfw_wsize');
  	if ( $tfw_wsize == "small" ) {
    		...
    		$goover = "top";
    		$fbwshr = "false";
    		$fbwshrcode = "<span style=\"background:#F1F3FA;border-radius:3px;padding:0 2px 0 1px;height:20px;border:1px solid #C0CAE9;\"><fb:share-button></fb:share-button></span><br><br>";
  	} else {
    		$twiwsize = "vertical";
    		$fbwsize = "box_count";
    		$fbwshr = "true";
