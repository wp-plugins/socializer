...
<br><br>
(Please note that <i>content trimming</i> plugins may cancel this option in Archive/Index views)
</div>
...
<div class="submit" style="padding:7pt;margin:32px 42px 30px 22px;-moz-border-radius: 17px;border-radius: 17px;">
		<input type="submit" name="info_update" value="<?php _e(' Update the options now'); ?>" /> or keep configuring
	</div>
...
Customize the Buttons &nbsp;<span style="color:grey;">(if you need to)</span>
</div>
<br>
...
<p style="font-size:14pt;letter-spacing:2px;margin-left:100px;">Enjoy!</p>
<br>
<br>
...
add_filter('the_content', 'tfw_generate', 500);
