...
add_option('tfw_stldiv', 'background: none; border: none; margin: 20px 5px 10px 5px; opacity: 1.0; border-spacing: 15px 5px; width: 500px;');
add_option('tfw_stlwdiv', 'background: none; border: none; padding:  10px 1px 10px 10px; border-spacing: 15px 10px; margin: 5px;');
add_option('tfw_stlfloatwdiv', 'box-shadow: 0 0 8px #D1D1D1; background: #FFFFFF; top: 35%; left: -1px; padding: 7px 3px 3px 1px;');
...
<label><input type="radio" name="tfw_floatsize" value="large" <?php if(get_option('tfw_floatsize')=="large") echo "checked";?>> <span style="letter-spacing:1px;">Display counts</span> in the Floating bar</label><br>
...
<b>Style Properties of the Floating Bar</b> &nbsp; &raquo; <a href="http://www.thefreewindows.com/socializer-style-editor/floating.php" target="_blank" style="text-decoration:none;color:#2b95ff;">Customize with the Style Editor</a>
<br>
...
<div style="padding:22px 33px 33px 0;margin:33px 0 0 0;border:1px solid #FBFBFB;-moz-border-radius: 22px;border-radius: 22px;">
...
<img src="<?=WP_CONTENT_URL.'/plugins/'.plugin_basename(dirname(__FILE__)).'/'?>screenshot-7.gif" style="border:none;border:0;margin-bottom:45px;padding-left:54px;">
...
<b>Style Properties of Sidebar Widgets</b> &nbsp; &raquo; <a href="http://www.thefreewindows.com/socializer-style-editor/sidebar.php" target="_blank" style="text-decoration:none;color:#2b95ff;">Customize with the Style Editor</a><br>
...
<img src="<?=WP_CONTENT_URL.'/plugins/'.plugin_basename(dirname(__FILE__)).'/'?>screenshot-5.gif" style="border:none;border:0;margin-bottom:5px;margin-left:177px;"><br>&nbsp;<br>
...
<b>Style Properties</b> &nbsp; &raquo; <a href="http://www.thefreewindows.com/socializer-style-editor/content.php" target="_blank" style="text-decoration:none;color:#2b95ff;">Customize with the Style Editor</a><br>
...
<label style="margin-left:20px;"><input type="radio" name="tfw_nowsize" value="large" <?php if(get_option('tfw_nowsize')=="large") echo "checked";?>> <span style="letter-spacing:1px;">Display counts</span> in Shortcode instances</label>
 &nbsp;  &nbsp;  
