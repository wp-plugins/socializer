...
<div id="SocializerW" style="<?=$the_social_stlwdiv ?>;"><a style="border:none;" href='http://www.socializer.info/share.asp?docurl=http://<?php echo $_SERVER["HTTP_HOST"] ?><?php echo $_SERVER["REQUEST_URI"]; ?>&doctitle=<?php wp_title(''); ?> <?php if ( is_home() ) { bloginfo("name"); } ?>' target="_blank"><img src="<?=$imadw ?>" alt="Share in top social networks!" style="padding:0;-moz-border-radius: 8px;border-radius: 8px;<?=$the_social_stlw ?>;"></a></div>
