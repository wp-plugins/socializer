...
Socializer! is a low resources free plugin to share your posts on Facebook, Twitter and more top social networks, Google Plus, by eMail...

== Description ==

With the free Socializer! plugin you can have your posts shared on more than 30 (top only) social networks, including Facebook (both "share" and "like" are supported) and Twitter, have them promoted in Google Plus, recommended by eMail... - always keeping your pages speedy, since Socializer! loads just a 6 K animated image, not the images of all the sites it can submit your posts to, nor lengthy scripts. This way your web site will stay fast, letting your visitors enjoy the content. 

Socializer! is absolutely self-dependent; it won't change anything in your database.

When a user clicks on the Socializer! button, a clean and pleasant control panel in a new window offers sharing options. Socializer! supports (in order of appearance): HTML Code (href) for Link and Share Link, Google and Google Plus submission, Reddit, Twitter, Facebook, eMail recommendation, BlinkList, BlogMarks, Del.Icio.Us, Digg, Fark, FriendFeed, Linkedin, Mixx, MySpace, StumbleUpon, Technorati, YahooMyWeb. And (second layer, appearing on demand): Co.mments, Connotea, DotNetKicks, DZone, Faves, LinkArena, LinkaGoGo, MisterWong, N4G, NewsVine, Netvouz, NuJIJ, Scoopeo, Sphinn, Tipd, Tumblr, Wikio, Xerpi.
...
Read [Frequent Questions and Answers](http://www.thefreewindows.com/6035/socializer-wordpress-frequent-questions-answers/) and ask yourself a question if you need to. You can also use the form on the same page to make suggestions (feature requests).
