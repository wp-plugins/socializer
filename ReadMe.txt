...
Tags: facebook, social, share, google, google plus,like, socializer, bookmark, follow,floating share buttons, social bookmarking, share widget, email, recommend, promote, twitter, del.icio.us, digg, language, translate, links, myspace, reddit, sharing, tweet, google translate, livejournal, tinyURL, evernote
Requires at least: 2.8
Tested up to: 3.9
Stable tag: 9.0

A fast plugin for sharing on top social networks, by eMail, giving HTML links and translations, helping explore and Follow, offering short links...


== Description ==

Socializer! helps your visitors to share your blog on more than 30 top social networks, including Facebook, Twitter, Google Plus, by eMail (including gMail), even translate them to their language, get short links, get HTML Reference and Share links, explore your blog more in Google search indexes, even Follow you..., *without compromising the speed of your pages*. You can see Socializer! in action, e.g. at [Live Desktop Gadgets](http://windowslivegadgets.com/gallery/)

Note that Socializer! won't *urge* your visitors to share your pages, it relies on their own spontaneous decision. If you want to *require* the sharing of your site, you can use [Social Share Motivator](http://www.thefreewindows.com/15816/reveal-posts-visitors-share-social-networks/)

**Socializer! is self-dependent and safe:** it does not interact with your database, and it keeps your blog speedy, since it loads immediately scripts for the most popular share options (Facebook, Twitter, Google Plus), postponing the rest for users who actually need them. 

Alternatively or along with content buttons, you can use the convenient and global Socializer! Widgets and the FLOATING Widget, a **vertical social bar** that remains visible all the time, no matter how long your pages are, on a fixed location *you* can define with *absolute* precision. You can use simple css directions to customize and fine tune the position, alignment, background, borders, etc, of the content and widget buttons according to your needs.

You have options to decide what to share, posts or pages, or both posts and pages, place social icons at the top of your content or at the bottom, or in both locations. Sharing buttons can appear also on Archives (Categories, Tags, Dates, etc), although this would be overwhelming for your visitors and is not recommended.

Socializer! share bars can be invoked even by using the **[SocializerNow]** shortcode anywhere you wish. You can also create manually [occasional share-links](http://www.thefreewindows.com/11487/incorporating-socializer-web-scripts-software-creating-manual-sharelinks/) independently of the regular buttons, in case that you need to use such references in some article.

Socializer! supports the option to **hide the counts** in icons that appear immediately on your pages, an option which can be very useful, if you don't want your visitors to see immediately how many times a post or page is shared, or even if you just need smaller versions of the sharing bars and widgets. 

Socializer! supports also **automatic detection of mobile phones**, in which case it lets you decide if you want to hide the floating social bar automatically, so that these visitors may read easily all of your posts in the limited space of their phone screens.

If you have a personal, business or fan page in Facebook, Twitter or Google Plus, you can let Socializer! add a **Follow** button among the sharing buttons. You can see how Follow works in a live preview e.g. [here](http://windowslivegadgets.com/gallery/)

Socializer! is compatible with WordPress multisite MS / MU installations. 

Social networks supported (and more options): Facebook, Twitter, Google Bookmarks and Google Plus, Reddit, eMail / gMail recommendation, Google Translate, copying raw HTML Code (href) for Links and Share Links, getting Short URL versions with TinyURL, share in BlinkList, BlogMarks, Chime, Del.Icio.Us, Digg, Evernote, FormSpring, FriendFeed, Linkedin, LiveJournal, MySpace, Pinterest, StumbleUpon, Technorati, Connotea, DotNetKicks, DZone,  Fark, Faves, LinkArena, LinkaGoGo, MisterWong, N4G, NewsVine, Netvouz, NuJIJ, Scoopeo, Tipd, Tumblr, Xerpi. 

* To increase your readership even more, use the free [Social Share Motivator](http://www.thefreewindows.com/15816/reveal-posts-visitors-share-social-networks/)

* [Socializer! Home](http://www.socializer.info) & [Plugin Page](http://www.thefreewindows.com/5598/socializer-share-WordPress-posts-pages/) are available if you need more information.
...
To install Socializer! follow the usual way of installing WordPress plugins: unzip the archive and upload the "socializer" folder inside the plugins folder of your blog, then activate Socializer! and configure it. 

Content, Shortcode, Simple and Floating Widget bars are all configured from the Socializer! page at the Settings section of your blog, and can be styled there further, even using your main style sheet.
...
4. Socializer! Floating Widget (the large version, displaying Counts, without background and border)

5. Socializer! Content / Shortcode buttons (not displaying Counts)

6. Socializer! Floating Widget (the smaller version, not displaying Counts, without background and border)

7. Socializer! Widget (the smaller version, not displaying Counts, without background and border)
