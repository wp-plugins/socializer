...
A very fast plugin for sharing on top social networks, by eMail, making HTML links, short links & translations, helping explore your site & Follow you...


== Description ==

Socializer! helps your visitors to share your blog on the top social networks, including Facebook, Twitter, Google Plus, and also by eMail (including gMail), even translate your pages, get short links, get HTML Reference links and Share links to use on their sites or share with their friends, explore your blog even more, even Follow you on Facebook, Twitter and Gooble Plus..., *without compromising the speed of your pages*. You can see Socializer! in action, e.g. at [Live Desktop Gadgets](http://windowslivegadgets.com/gallery/)

**Socializer! is self-dependent and safe:** it does not interact with your database, and it keeps your blog speedy, since it loads immediately scripts for popular share options (Facebook, Twitter, Google Plus), postponing the rest for users who might actually need them. 

Alternatively or along with content share bars, you can use the convenient global Socializer! FLOATING icons, a *vertical social bar* that remains visible all the time, no matter how long your pages are, on a fixed location you can define with precision. Normal Sidebar widgets are also available. 

You can use simple CSS directions to customize and fine tune the position, alignment, background, borders, etc, of the Share bars and widgets according to your needs. If you are not very familiar with CSS or just preferring a preview of your settings before you apply them, you can use the On Line [Socializer! Style Editor](http://www.thefreewindows.com/socializer-style-editor/index.php), a free tool, accessible from the Socializer! settings page in your dashboard.
...
Socializer! Share bars can be invoked also by using the **[SocializerNow]** Shortcode anywhere you like. 
...
* To increase your readership further, you may also like to use the free [Social Share Motivator](http://www.thefreewindows.com/15816/reveal-posts-visitors-share-social-networks/), a plugin that will let you require the sharing of your blog.
